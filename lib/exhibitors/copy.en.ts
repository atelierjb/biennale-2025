...
export const exhibitorCopyEN: Record<number, ExhibitorCopy> = {
  1: {
  ...
  6: {
    ...
    dimensions: [
      "H: 230 mm, B: 180 mm, 60 mm wide at the base",
  ...
  13: {
    ...
    dimensions: [
      "All spoons are based on silver bar dimensions 10 x 10 x 70 mm",
    ],
    description: [
